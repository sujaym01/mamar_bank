...
class UserRegistrationForm(UserCreationForm):
    ...
    def save(self, commit=True):
        ...
        if commit == True:
            ...
            # Retrieving cleaned data from the form
            ...
            # Creating related UserAddress and UserBankAccount objects
            # Creating a new instance of the UserAddress and UserBankAccount model and saving it to the database
...
# In Django, model_name.objects.create() is a way to
# create and save a new instance of a model in the database. 
